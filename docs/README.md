...
This directory contains the working documentation for Contacts CLI. Start here when you need to
understand how to use, maintain, test, or release the application.
