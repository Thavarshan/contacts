...
```bash
java -jar target/contacts-1.0.0-SNAPSHOT-cli.jar --file contacts.csv search acme
```
...
```bash
java -jar target/contacts-1.0.0-SNAPSHOT-cli.jar --file contacts.csv import import.csv
```

Replace current contacts:

```bash
java -jar target/contacts-1.0.0-SNAPSHOT-cli.jar --file contacts.csv import import.csv --replace
```
